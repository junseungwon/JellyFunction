	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float temp_output_79_0 = saturate( ( pow( 0.0 , _ToDropletsCutPower ) * _ToDropletsCutMultiply ) );
				...
				float4 temp_output_64_0 = ( ( ( _Ero + IN.ase_texcoord8.z ) * saturate( 0.0 ) ) + saturate( ( 1.0 - saturate( ( pow( tex2D( _CutoutTexture, uv_CutoutTexture ) , temp_cast_1 ) * _CutoutMult ) ) ) ) );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float4 temp_output_64_0 = ( ( ( _Ero + IN.ase_texcoord3.z ) * saturate( 0.0 ) ) + saturate( ( 1.0 - saturate( ( pow( tex2D( _CutoutTexture, uv_CutoutTexture ) , temp_cast_0 ) * _CutoutMult ) ) ) ) );
				float2 appendResult95 = (float2(WorldPosition.x , WorldPosition.z));
				float2 panner67 = ( 1.0 * _Time.y * _UVPan + ( appendResult95 * _UVScale ));
				float2 panner69 = ( 1.0 * _Time.y * _UVDPan + ( appendResult95 * _UVDScale ));
				float2 lerpResult62 = lerp( float2( 0,0 ) , ( ( (tex2D( _MainTexture1, panner69 )).rg + -0.5 ) * 2.0 ) , _UVDLerp);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 temp_cast_1 = (_CutoutPower).xxxx;
				float4 temp_output_64_0 = ( ( ( _Ero + IN.ase_texcoord4.z ) * saturate( 0.0 ) ) + saturate( ( 1.0 - saturate( ( pow( tex2D( _CutoutTexture, uv_CutoutTexture ) , temp_cast_1 ) * _CutoutMult ) ) ) ) );
				float4 smoothstepResult37 = smoothstep( temp_output_64_0 , ( temp_output_64_0 + float4( 1,0,0,0 ) ) , lerpResult42);
				float4 lerpResult34 = lerp( lerpResult42 , saturate( smoothstepResult37 ) , _LUTErosion);
				float2 panner31 = ( 1.0 * _Time.y * temp_cast_0 + ( ( lerpResult34 * _LUTRange ) + _LUTOffset ).rg);
				float4 tex2DNode96 = tex2D( _LUT, panner31 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 temp_cast_1 = (_CutoutPower).xxxx;
				float4 temp_output_64_0 = ( ( ( _Ero + IN.ase_texcoord2.z ) * saturate( 0.0 ) ) + saturate( ( 1.0 - saturate( ( pow( tex2D( _CutoutTexture, uv_CutoutTexture ) , temp_cast_1 ) * _CutoutMult ) ) ) ) );
				float4 smoothstepResult37 = smoothstep( temp_output_64_0 , ( temp_output_64_0 + float4( 1,0,0,0 ) ) , lerpResult42);
				float4 lerpResult34 = lerp( lerpResult42 , saturate( smoothstepResult37 ) , _LUTErosion);
				float2 panner31 = ( 1.0 * _Time.y * temp_cast_0 + ( ( lerpResult34 * _LUTRange ) + _LUTOffset ).rg);
				float4 tex2DNode96 = tex2D( _LUT, panner31 );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float4 temp_cast_0 = (_CutoutPower).xxxx;
				float4 temp_output_64_0 = ( ( ( _Ero + IN.ase_texcoord5.z ) * saturate( 0.0 ) ) + saturate( ( 1.0 - saturate( ( pow( tex2D( _CutoutTexture, uv_CutoutTexture ) , temp_cast_0 ) * _CutoutMult ) ) ) ) );
				float4 lerpResult42 = lerp( tex2D( _LiquidTexture, temp_output_54_0 ) , tex2D( _LiquidSecondaryTexture, temp_output_58_0 ) , temp_output_79_0);
				float4 smoothstepResult73 = smoothstep( temp_output_64_0 , ( temp_output_64_0 + _EroSSSmoothness ) , lerpResult42);
				float4 op118 = saturate( ( IN.ase_color.a * saturate( smoothstepResult73 ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float4 temp_cast_0 = (_CutoutPower).xxxx;
				float4 temp_output_64_0 = ( ( ( _Ero + IN.ase_texcoord.z ) * saturate( 0.0 ) ) + saturate( ( 1.0 - saturate( ( pow( tex2D( _CutoutTexture, uv_CutoutTexture ) , temp_cast_0 ) * _CutoutMult ) ) ) ) );
...
Node;AmplifyShaderEditor.SamplerNode;99;-8192,256;Inherit;True;Property;_LiquidTexture;Liquid Texture;10;0;Create;True;0;0;0;False;3;Space(13);Header(Liquid Texture);Space(33);False;-1;64f823e64f4977243bb7c015fa29d472;64f823e64f4977243bb7c015fa29d472;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;100;-8192,1152;Inherit;True;Property;_LiquidSecondaryTexture;Liquid Secondary Texture;13;0;Create;True;0;0;0;False;3;Space(13);Header(Liquid Secondary Texture);Space(33);False;-1;64f823e64f4977243bb7c015fa29d472;64f823e64f4977243bb7c015fa29d472;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;114;-2944,-1792;Inherit;False;Property;_SlimeColorSpecular;Slime Color Specular;32;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;121;-3968,-1280;Inherit;False;Property;_SlimeColorBase01;Slime Color Base 01;30;0;Create;True;0;0;0;False;3;Space(33);Header(Oil Color);Space(13);False;0.4171708,1,0,0;0.4156863,1,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;120;-3968,-1104;Inherit;False;Property;_SlimeColorBase02;Slime Color Base 02;31;0;Create;True;0;0;0;False;0;False;0.4402515,0.3744411,0,0;0.4392157,0.372549,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;98;-5760,-512;Inherit;True;Property;_LiquidNormal;Liquid Normal;16;0;Create;True;0;0;0;False;3;Space(13);Header(Liquid Normal);Space(33);False;-1;aaf6d9d855e7074468950ee57023a62b;aaf6d9d855e7074468950ee57023a62b;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=FAA142D0EBFFEE8144A47801557F655FC6584C04